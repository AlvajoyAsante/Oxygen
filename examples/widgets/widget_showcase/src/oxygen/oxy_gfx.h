...
struct oxy_FrameManager_t{
	uint8_t frame;
	uint16_t time;
};
extern struct oxy_FrameManager_t oxy_FrameManager;
...
/**
* Draws a Transparent GIF/Animation. (put in a loop)
* @param frames 
...
/**
* Draws a Non-Transparent GIF/Animation. (put in a loop)
* @param frames 
* @param frame_change_time 
* @param frame_amount 
* @param x X coordinate.
...
/**
* Update GIF Animations. (put in a loop)
* @param frame_change_time 
*/
